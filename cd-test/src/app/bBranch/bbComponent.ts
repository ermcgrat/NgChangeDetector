...
@Component({
  selector: 'bb-comp',
  template: `
  <div (click)="clickIt()">BBComponent Title: {{data.title}}</div>
  `
})
export class BBComponent implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked {

  @Input() data;

  compName = 'BBComponent';
